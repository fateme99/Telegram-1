...
public class AndroidUtilities {
    ...
    public static String getGlobalFont() {
        int fontValue = SharedConfig.fontType;
        String assetPath = "";
        switch (fontValue) {
            case 0:
    ...
    public static SpannableStringBuilder replaceTags(String str, int flag, Object... args) {
        try {
            ...
            for (int a = 0; a < bolds.size() / 2; a++) {
                spannableStringBuilder.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont())), bolds.get(a * 2), bolds.get(a * 2 + 1), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
            }
            return spannableStringBuilder;
        } catch (Exception e) {
            FileLog.e(e);
