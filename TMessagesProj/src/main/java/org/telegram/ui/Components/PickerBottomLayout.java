...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean darkTheme) {
        ...
        doneButtonBadgeTextView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont()));
        ...
        doneButtonTextView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont()));
