...
public class GroupCallRecordAlert extends BottomSheet {
    ...
    public GroupCallRecordAlert(Context context, TLRPC.Chat chat, boolean hasVideo) {
        ...
        positiveButton.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont()));
        ...
        for (int a = 0; a < titles.length; a++) {
            ...
            titles[a].setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont()));
