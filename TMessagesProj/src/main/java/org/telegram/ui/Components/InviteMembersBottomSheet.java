        ...
        floatingButton.setOnClickListener(v -> {
            ...
            if (dialogsDelegate != null) {
                ...
                if (selectedContacts.size() > 5) {
                    ...
                    if (index >= 0) {
                        spannableStringBuilder.setSpan(new TypefaceSpan(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont())), index, index + countString.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    }
