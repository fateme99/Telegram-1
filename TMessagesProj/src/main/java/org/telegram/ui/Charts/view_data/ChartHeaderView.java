...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context) {
        ...
        title.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont()));
        ...
        dates.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont()));
        ...
        datesTmp.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont()));
