...
public class LegendSignatureView extends FrameLayout {
    ...
    public LegendSignatureView(Context context) {
        ...
        time.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont()));
        hourTime = new TextView(context);
        hourTime.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 14);
        hourTime.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont()));
    ...
    class Holder {
        ...
        Holder() {
            ...
            if (showPercentage) {
                ...
                percentage.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont()));
            ...
            value.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont()));
