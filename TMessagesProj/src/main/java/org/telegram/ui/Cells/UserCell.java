...
public class UserCell extends FrameLayout {
    ...
    public UserCell(Context context, int padding, int checkbox, boolean admin, boolean needAddButton) {
        ...
        if (needAddButton) {
            ...
            addButton.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont()));
        ...
        if (admin) {
            ...
            adminTextView.setTypeface(AndroidUtilities.getTypeface(AndroidUtilities.getGlobalFont()));
